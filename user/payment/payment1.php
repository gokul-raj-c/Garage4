...
<body>
	<div class="main">
								...
								<div class="resp-tabs-container">
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
										<div class="payment-info">
											...
											<form action="paymentanimation1.php">
												<div class="tab-for">				
													<h5>NAME ON CARD</h5>
									...
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-3">	
										<div class="payment-info">
											...
											<form action="paymentanimation.php">
												<div class="tab-for">				
													<h5>NAME ON CARD</h5>
														<input type="text" value="" required="">
													<h5>CARD NUMBER</h5>													
											...
											<div class="single-bottom">
													<ul>
														<li>
													<!-- 		<input type="checkbox"  id="brand" value="" required="">
															<label for="brand"><span></span>By checking this box, I agree to the Terms & Conditions & Privacy Policy.
</form> -->
															</label>
														</li>
													</ul>
		...
		<p class="footer">Copyright © Needleworker All Rights Reserved </p>
	</div>
</body>
</html>